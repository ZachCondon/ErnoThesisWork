...
# 1. Define Functions                                                         #
###############################################################################
# To be honest, I haven't gone into each function to see what it does or how it
#  does it. This code came directly from the paper I linked in the spectra_generation.py
#  file and it works, so that was good enough for me.
def thermal(E, T_0):
